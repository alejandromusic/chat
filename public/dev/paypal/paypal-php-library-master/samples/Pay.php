...
$PayRequestFields = array(
						'ActionType' => 'PAY', 								
						// Required.  Whether the request pays the receiver or 
						// whether the request is set up to create a payment request, 
						// but not fulfill the payment until the ExecutePayment is called.  
						// Values are:  PAY, CREATE, PAY_PRIMARY
						
						'CancelURL' => $domain.'paypal/class/1.2/Pay_Cancel.php', 									
						// Required.  The URL to which the sender's browser is redirected 
						// if the sender cancels the approval for the payment after 
						// logging in to paypal.com.  1024 char max.
